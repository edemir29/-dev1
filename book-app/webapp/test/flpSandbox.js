		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Books App",
									"targetURL": "#ZUXEXP01bookapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ZUXEXP01bookapp-display": {
								"semanticObject": "ZUXEXP01bookapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZUXEXP01.bookapp",
									"url": sap.ui.require.toUrl("ZUXEXP01/bookapp")
								}
							}
						}
					}
